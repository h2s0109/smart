...
# print('"foo.bar" valid? ' + str(is_pathname_valid('c:\\foo.bar')))
# print('Null byte valid? ' + str(is_pathname_valid('\x00')))
# print('Long path valid? ' + str(is_pathname_valid('a' * 256)))
# print('Long path valid? ' + str(is_pathname_valid('')))
# print('"/dev" exists or creatable? ' + str(is_path_exists_or_creatable('/dev')))
# print('"/dev/foo.bar" exists or creatable? ' +
#       str(is_path_exists_or_creatable('/dev/foo.bar')))
# print('Null byte exists or creatable? ' +
#       str(is_path_exists_or_creatable('\x00')))
# print('Null byte exists or creatable? ' +
#       str(is_path_exists_or_creatable('')))
# print('"\dev\foo.bar" exists or creatable? ' +
#       str(is_path_exists_or_creatable('\dev\foo.bar')))
...
def Copypath_creation(copypath):
    for path in copypath:
        if os.path.exists(copypath[path]):
            remove_dir(copypath[path])
        else:
            os.makedirs(copypath[path])
    return


def windowinstallpathini(pjname):
