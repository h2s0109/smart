...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.tabWidget.setStyleSheet("QTabBar::tab { height: 25px; min-width: 25px; }")#temp
        ...
        self.RelieveModuleTreeView = QtWidgets.QTreeView(self.tabSource)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.RelieveModuleTreeView.sizePolicy().hasHeightForWidth())
        self.RelieveModuleTreeView.setSizePolicy(sizePolicy)
        self.RelieveModuleTreeView.setMinimumSize(QtCore.QSize(0, 300))
        self.RelieveModuleTreeView.setObjectName("RelieveModuleTreeView")
        self.gridLayout.addWidget(self.RelieveModuleTreeView, 1, 1, 1, 1)
        self.SetModuleTreeView = QtWidgets.QTreeView(self.tabSource)
        self.SetModuleTreeView.setObjectName("SetModuleTreeView")
        self.gridLayout.addWidget(self.SetModuleTreeView, 1, 4, 1, 1)
        self.verticalLayout_3 = QtWidgets.QVBoxLayout()
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        spacerItem = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_3.addItem(spacerItem)
        self.SetModuleButton = QtWidgets.QPushButton(self.tabSource)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.SetModuleButton.sizePolicy().hasHeightForWidth())
        self.SetModuleButton.setSizePolicy(sizePolicy)
        self.SetModuleButton.setMinimumSize(QtCore.QSize(70, 0))
        self.SetModuleButton.setMaximumSize(QtCore.QSize(70, 16777215))
        self.SetModuleButton.setText("")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("Ico/config_add.gif"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.SetModuleButton.setIcon(icon)
        self.SetModuleButton.setObjectName("SetModuleButton")
        self.verticalLayout_3.addWidget(self.SetModuleButton)
        self.RelieveModuleButton = QtWidgets.QPushButton(self.tabSource)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.RelieveModuleButton.sizePolicy().hasHeightForWidth())
        self.RelieveModuleButton.setSizePolicy(sizePolicy)
        self.RelieveModuleButton.setMinimumSize(QtCore.QSize(70, 0))
        self.RelieveModuleButton.setMaximumSize(QtCore.QSize(70, 16777215))
        self.RelieveModuleButton.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("Ico/config_delete.gif"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.RelieveModuleButton.setIcon(icon1)
        self.RelieveModuleButton.setObjectName("RelieveModuleButton")
        self.verticalLayout_3.addWidget(self.RelieveModuleButton)
        spacerItem1 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_3.addItem(spacerItem1)
        self.gridLayout.addLayout(self.verticalLayout_3, 1, 2, 1, 2)
        self.plainTextEdit_Install = QtWidgets.QPlainTextEdit(self.tabSource)
        self.plainTextEdit_Install.setObjectName("plainTextEdit_Install")
        self.gridLayout.addWidget(self.plainTextEdit_Install, 2, 1, 1, 4)
        ...
        self.plainTextEdit = QtWidgets.QPlainTextEdit(self.tabDestination)
