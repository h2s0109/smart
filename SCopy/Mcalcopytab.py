...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.PorjectCheckBox.setToolTip(_translate("Dialog", "<html><head/><body><p>Project path inludes the module paths.</p></body></html>"))
        self.PorjectCheckBox.setWhatsThis(_translate("Dialog", "<html><head/><body><p>Project path inludes the module paths.</p></body></html>"))
