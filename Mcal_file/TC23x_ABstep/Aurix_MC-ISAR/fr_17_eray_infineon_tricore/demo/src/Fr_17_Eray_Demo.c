...
/*  UNUSED_PARAMETER(ErrorCount)*/
  ...
  Fr_17_Eray_Init(&Fr_17_Eray_ConfigRoot[1]);
#endif

/*Clock Out*/
Mcal_ResetSafetyENDINIT_Timed(FR_SAFETY_ENDINT_TIMEOUT);
   SCU_EXTCON.B.SEL0 = 2;
   SCU_EXTCON.B.EN0 = 1; 
...
/*----------------------------------------------------------------------------*/
  ...
  {
    PlcBytes = Fr_17_Eray_ConfigRoot[0].CfgPtr[0].LPduConfigPtr[LPduIndex].WRHS2.B.PayloadLengthConfigured * 2 ;
...
/*----------------------------------------------------------------------------*/
  ...
  {  
    ...
    do 
    {
      RetValue = Fr_17_Eray_ReceiveRxLPdu(0, RxLPduIdx, (uint8*) &FrDemo_RxDataBuffer, 
